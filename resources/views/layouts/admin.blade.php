...
<head>
  ...
  <title>{{ config('app.name', 'Plus 65 | Admin Portal') }}</title>
...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset('public/bower_components/admin-lte/dist/img/user2-160x160.jpg') }}" class="user-image" alt="User Image">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; {{ date('Y')}} <a href="#">Plus 65 </a>.</strong> All rights
    reserved.
  </footer>
